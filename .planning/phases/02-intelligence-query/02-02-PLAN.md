...
must_haves:
  ...
  key_links:
    ...
    - from: "src/services/query/intent.ts"
      ...
      pattern: "from './types'"
    - from: "src/services/query/intent.ts"
      to: "src/services/nlp/normalizer.ts"
      via: "normalizer import"
      pattern: "from '../nlp/normalizer'"
---
...
```
  ...
  <verify>
    ...
    - Check normalizer import: `grep "from '../nlp/normalizer'" src/services/query/intent.ts`
...
# Verify key import (normalizer in intent.ts)
grep "from '../nlp/normalizer'" src/services/query/intent.ts
...
- Intent extraction imports normalizeVietnamese from '../nlp/normalizer'
